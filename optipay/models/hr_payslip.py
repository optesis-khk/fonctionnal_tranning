...
class BonusRuleInput(models.Model):
    ...
    def action_payslip_done(self):
        for payslip in self:
            if payslip.worked_days_line_ids[0].number_of_days != 0:
                ...
                provision_amount += sum(line.total for line in payslip.details_by_salary_rule_category if line.code == 'C1150')
                payslip.contract_id._get_droit(provision_amount)
    ...
    def update_recompute_ir(self):
        ...
        for payslip in self:
            ...
            #regul_mensuel = [obj for obj in payslip.line_ids if obj.code == 'C2150']
